...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("layout", "Layout", choices = c("grid", "fixed", "mosaic", "masonry", "justified", "elastic", "rhombus", "hexagon"), selected = "grid"),
...
Pixcarousel can be used in shiny using `pixcarouselOutput()` and `renderPixcarousel()`. Run `launchApp(app = "pixcarousel")` to view the demo app.

![](shiny-pixcarousel.webp)
