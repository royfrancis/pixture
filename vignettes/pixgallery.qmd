...
```{r}
#| label: shuffle-with-captions-lightbox-captions
pixgallery(
  paths_a[1:6],
  shuffle = TRUE,
...
rownames(dfr) <- paste(
  rep(
    c("grid", "fixed", "mosaic", "masonry", "justified", "elastic", "rhombus"),
    each = 3
  ),
