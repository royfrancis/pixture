...
Please note that not all parameters are applicable to every layout. The table below indicates which parameters are active for each layout type.
...
dfr <- data.frame(
  ...
  "option"    = c("", "none", "top/bottom", "center", "below", "", "", "", "", "", "", ""),
  "grid"      = c("🟩", "🟩", "🟩", "🟩", "🟩", "🟩", "🟩", "🔵", "🟩", "🟩", "🟩", "🟩"),
  "fixed"     = c("🟩", "🟩", "🟡", "🟡", "🟩", "🟩", "🟩", "🟩", "🟩", "🟩", "🟩", "🟩"),
  "mosaic"    = c("🟩", "🟩", "🟩", "🟩", "🟩", "🟩", "🟩", "🔵", "🟩", "🟩", "🟩", "🟩"),
  "masonry"   = c("🟩", "🟩", "🟡", "🟡", "🟩", "🟩", "🟩", "🔴", "🟩", "🟩", "🟩", "🟩"),
...
🟡 *Long captions extend beyond the images and/or clipped*  
...
Column-wise layout with free height. The thumbnail width can be adjusted.
...
Row-wise layout with free width. The thumbnail height can be adjusted.
