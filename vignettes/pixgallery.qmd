...
```{r}
#| label: custom-link-captions
pixgallery(paths_a[1:4], caption = captions[1:4], link = c("https://en.wikipedia.org/wiki/Milky_Way", "https://en.wikipedia.org/wiki/Rainforest", "https://en.wikipedia.org/wiki/Shark", "https://en.wikipedia.org/wiki/Hawaii"))
```
...
```{r}
#| label: hexagon-layout-custom
pixgallery(paths_a[1:6], layout = "hexagon", gap = "2px", caption = captions[1:6], caption_valign = "center", caption_halign = "center", border_radius = "8px", h = "250px", shuffle = TRUE)
```

With long captions.

```{r}
#| label: hexagon-layout-long-captions
pixgallery(paths_a[1:6], layout = "hexagon", gap = "2px", caption = captions_long[1:6], caption_valign = "center", caption_halign = "center")
```
