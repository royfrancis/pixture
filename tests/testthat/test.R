...
expect_silent(pixgallery(paths,h="100px"))
expect_silent(pixgallery(paths,w="100px"))
expect_silent(pixgallery(paths,h="100px",w="100px"))
expect_silent(pixgallery(paths,gap="10px"))
expect_silent(pixgallery(paths,h="100px",w="50px",gap="5px"))
